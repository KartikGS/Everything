...
> [!NOTE]
> Principle layering:
> - Cross-project principles: `/projects/Everything/general/agents/coordination/general-principles.md`
> - For project-specific principles, see your project's context extension (e.g., `context/product/project-principles.md`).
...
*   **Contextual Cross-Referencing**: Check the project's decisions registry and architecture documentation before touching sensitive areas like security, telemetry, or core data flow.
